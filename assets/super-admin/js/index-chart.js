(function($) {
 ...
 /* Engaged Users */
  ...
  gradientStrokeengagedUsers.addColorStop(0, '#ff4c01');

  var gradientFillengagedUsers = engagedUsersCtx.createLinearGradient(0, 0, 0, 240);
  gradientFillengagedUsers.addColorStop(0, "rgb(255, 76, 1)");
  gradientFillengagedUsers.addColorStop(1, "rgba(255,255,255)");
  ...
  gradientStrokepageImpressions.addColorStop(0, '#ff4c01');

  var gradientFillpageImpressions = pageImpressionsCtx.createLinearGradient(0, 0, 0, 240);
  gradientFillpageImpressions.addColorStop(0, "rgb(255, 76, 1)");
  gradientFillpageImpressions.addColorStop(1, "rgba(255,255,255)");
  ...
  // Overview slider
    ...
    var lineChart = new Chart(ctx, {
      ...
      options: {
        ...
        gradientStroke2.addColorStop(0, '#ff4c01');

        var gradientFill2 = ctx2.createLinearGradient(0, 0, 0, 240);
    ...
    gradientStrokePeercoin.addColorStop(0, '#ff4c01');

    var gradientFillPeercoin = peerCoinCtx.createLinearGradient(0, 0, 0, 240);
    gradientFillPeercoin.addColorStop(0, "rgb(255, 76, 1)");
    gradientFillPeercoin.addColorStop(1, "rgba(255,255,255)");
