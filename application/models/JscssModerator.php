...
class JscssModerator extends CI_Model

{
...

	{
		...
		if ($page == 'moderationlist' || $page == 'create_province' || $page == 'create_district' || $page == 'create_region' || $page == 'create_city' || $page == 'organisation_list' || $page == 'programmer_list' || $page == 'create_attendance' || $page == 'training_list' || $page == 'facilitator_list' || $page == 'assessor_list' || $page == 'moderator_list' || $page == "create_attendance") {
...

	{
		...
		if ($page == 'moderationlist' || $page == 'moderator_editprofile' || $page == 'create_attendance' || $page == 'create_region' || $page == 'create_city' || $page == 'organisation_list' || $page == 'programmer_list' || $page == 'project_list' || $page == 'training_list' || $page == 'facilitator_list' || $page == 'assessor_list' || $page == 'moderator_list' || $page = "changepassword" || $page == "create_attendance") {
		...
		if ($page == 'moderator_editprofile') {
			...
			$('.province').change(function(){
				...
				$.ajax({
					...
					url: 'internal-moderator-getdestrict',
			...
			function deleterecord(tablename,columnname,id){
				...
				$('.learnership_sub_type_id').change(function(){
			        ...
			        $.ajax({
			            ...
			            url: 'external-moderator-getunitstandard',
