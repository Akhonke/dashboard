                                ...
                                <tr id="del-<?= $value->id ?>" class="filters">
                                    ...
                                    <a href="#" data-toggle="modal" data-target="#exampleModal" data-id="<?=  $value->id?>" data-name="<?=  $value->id?>" onclick="view(<?=   $value->id; ?>)"  class="btn btn-primary btn-sm preview_product"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                      ...
                                      <div class="modal fade " id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <a href="facilitator-create-attendance?id=<?= $value->id ?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>
        ...
        debugger;
  		...
  		$("#exampleModal").modal({
            ...
            if(src.length > 1){
              ...
              $(this).find("#personDetails").html($("<div class=row><div class=col-sm-6>Training Provider : " + company_name + 
              "</div><div class=col-sm-6>Learnership Sub Type : " + learnership_nm + 
              "</div><div class=col-sm-6>ClassName : " + learner_nm + 
              "</div><div class=col-sm-6>Facilitator  : " + facilitator_name + 
              "</div><div class=col-sm-6>Year  : " + class_name + 
              "</div><div class=col-sm-6>Week Ending Date  : " + year + 
