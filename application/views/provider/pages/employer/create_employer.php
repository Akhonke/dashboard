            ...
            <div class="col-lg-12 mb-1">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <h3 class="h6 text-uppercase mb-0"><?= $name; ?> Learner Place Of Employment</h3>
                    ...
                    <div class="card-body">
                        ...
                        <form class="form-horizontal" method="post" id="CreateEmployerForm" enctype="multipart/form-data">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <label class="form-control-label">Employer Province</label>
                                    <select class="form-control employer_province" name="employer_province">
                                        <option label="Choose Your Employer Province"></option>
                                        <?php 
                                        ...
                                        <option value="<?= $value->name  ?>"
                                             <?php 
                                                ...
                                                if($record->employer_province == $value->name){ ?> selected="selected" 
                                            <?php } }?>
                                            ><?= $value->name  ?>
                                        </option>
                                        <?php }
                                ...
                                <div class="col-md-6">
                                    <label class="form-control-label">Employer District</label>
                                       <select class="form-control employer_district_option" name="employer_district">
                                            <?php if(!empty($_GET['id'])){ 
                                            ...
                                            ?>
                                                <option value="<?= $value->id ?>"
                                                    <?php 
                                                        ...
                                                        if($record->employer_district == $value->name){ ?> selected="selected" 
                                                    <?php } }?>
                                                    ><?= $value->name ?></option>
                                            <?php
                                            } } }else{ ?>
                                               <option label="Select Your Employer District"></option>
                                            <?php } ?>
                                       </select>
                                    <label id="employer-district-error" class="error" for="employer_district"></label>
                                </div>

                                <div class="col-md-6">
                                    <label class="form-control-label">Employer Region</label>
                                      <select class="form-control" id="employer_region" name="employer_region">
                                       <?php if(!empty($_GET['id'])){ 
                                        ...
                                        ?>
                                            <option value="<?= $value->id ?>"
                                                <?php 
                                                    ...
                                                    if($record->employer_region == $value->region){ ?> selected="selected" 
                                                <?php } }?>
                                                ><?= $value->region ?></option>
                                        <?php
                                            } } }else{ ?>
                                         <option label="Select Your Employer Region"></option>
                                     <?php } ?>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    <label class="form-control-label">Employer City</label>
                                    <select class="form-control" name="employer_city" id="employer_city">
                                           ...
                                           ?>
                                            <option value="<?= $value->id ?>"
                                                <?php 
                                                    ...
                                                    if($record->employer_city == $value->city){ ?> selected="selected" 
                                                <?php } }?>
                                                ><?= $value->city ?></option>
                                            <?php
                                            }  } }else{ ?>
                                                <option label="Select Your Employer City"></option>
                                                <?php
                                            } ?>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    <label class="form-control-label">Employer Suburb</label>
                                ...
                                <div class="col-md-6">
                                    <label class="form-control-label">Employer Street Name</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" placeholder="Enter Your Employer Street Number" class="form-control" name="employer_Street_number" value="<?= (isset($record)) ? $record->employer_Street_number : ''; ?>">
                                ...
                                <div class="col-md-6">
                                   ...
                                   <label id="contact_person_name-error" class="error" for="contact_person_name"></label>
                                    ...
                                    <label class="form-control-label">Contact Person Surname</label>
