      ...
      <div class="col-xl-3 col-lg-6 mb-4 mb-xl-0">
        <div class="bg-white shadow roundy p-4 h-100 d-flex align-items-center justify-content-between">
          <div class="flex-grow-1 d-flex align-items-center">
            ...
            <div class="text">
              <h6 class="mb-0">Total Tasks</h6><span class="text-gray"><?= $task ?></span>
            </div>
          </div>
      ...
      <div class="col-xl-3 col-lg-6 mb-4 mb-xl-0">
        <div class="bg-white shadow roundy p-4 h-100 d-flex align-items-center justify-content-between">
          <div class="flex-grow-1 d-flex align-items-center">
            ...
            <div class="text">
              <h6 class="mb-0">Total Stipends</h6><span class="text-gray"><?= $stipend ?></span>
            </div>
          </div>
      ...
      <div class="col-xl-3 col-lg-6 mb-4 mb-xl-0">
        <div class="bg-white shadow roundy p-4 h-100 d-flex align-items-center justify-content-between">
          <div class="flex-grow-1 d-flex align-items-center">
            <div class="dot mr-3 bg-violet"></div>
            <div class="text">
              <h6 class="mb-0">Total Employee</h6><span class="text-gray"><?= $employee ?></span>
            </div>
          </div>
          <div class="icon text-white bg-violet"><i class="fas fa-server"></i></div>
        </div>
      ...
      <div class="col-xl-3 col-lg-6 mb-4 mb-xl-0">
        <div class="bg-white shadow roundy p-4 h-100 d-flex align-items-center justify-content-between">
          <div class="flex-grow-1 d-flex align-items-center">
            <div class="dot mr-3 bg-violet"></div>
            <div class="text">
              <h6 class="mb-0">Total External Moderator</h6><span class="text-gray"><?= $external_moderator ?></span>
            </div>
          </div>
          <div class="icon text-white bg-violet"><i class="fas fa-server"></i></div>
        </div>
      ...
      <div class="col-xl-3 col-lg-6 mb-4 mb-xl-0">
        <div class="bg-white shadow roundy p-4 h-100 d-flex align-items-center justify-content-between">
          <div class="flex-grow-1 d-flex align-items-center">
            <div class="dot mr-3 bg-green"></div>
            <div class="text">
              <h6 class="mb-0">Total Learner</h6><span class="text-gray"><?= $learner ?></span>
            </div>
          </div>
          <div class="icon text-white bg-green"><i class="far fa-clipboard"></i></div>
        </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="chart-holder">
              ...
              <canvas id="lineChart1" style="max-height: 14rem !important; display: block; width: 529px; height: 264px;" class="w-100 chartjs-render-monitor" width="529" height="264"></canvas>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="card-body">
            <div class="row align-items-center flex-row">
              ...
              <div class="col-lg-7">
                ...
                <canvas id="pieChartHome1" width="201" height="100" class="chartjs-render-monitor" style="display: block; width: 201px; height: 100px;"></canvas>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-lg-4">
        ...
        <div class="card px-5 py-4">
          ...
          <div class="chart-holder">
            ...
            <canvas id="lineChart3" style="max-height: 7rem !important; display: block; width: 230px; height: 114px;" class="w-100 chartjs-render-monitor" width="230" height="114"> </canvas>
          </div>
        </div>
      </div>
    </div>
