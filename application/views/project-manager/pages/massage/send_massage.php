            ...
            <div class="col-lg-12 mb-1">
               <div class="card">
                  <div class="card-header">
                     <h3 class="h6 text-uppercase mb-0">Compose Message</h3>
                  </div>
                  <div class="card-body">
                     <style>
                        .myaccount-tab-menu {
                              ...
                              <form action="" method="POST" enctype="multipart/form-data">
                                 <div class="row">
                                    <div class="col-md-6 form-group">
                                       <label class="form-control-label">Receiver Type<span style="color:red;font-weight:bold;"> *</span></label>
                                       <select class="form-control" name="receiver_type" id="receiver_type">
                                          <option value=""  hidden>Select Your Receivers Type</option>
                                    ...
                                    <div class="col-md-6 form-group">
                                       ...
                                       <select class="form-control" name="receiver[]" id="receiver" multiple>
                                          <option value="" hidden>Select Your Receivers</option>
                                    ...
                                    <div class="col-md-6 form-group">
                                       ...
                                       <input type="text" placeholder="Enter Your Subject" class="form-control" value="" id="subject" name="subject">
