                                ...
                                <tbody>
                                    ...
                                    if (!empty($record)) {
                                        ...
                                        foreach ($record as $key => $row) {
                                            ...
                                            $learnership_sub_type = $this->common->accessrecord(' learnership_sub_type', [], ['id' => $row->learnership_sub_type], 'row');
...
<script>
    function view() {
        ...
        $("#exampleModal").modal({
            ...
            $(this).find("#personDetails").html($("<div class=row><div class=col-sm-12>Learner Name :  " + learner_name +
                "</div><div class=col-sm-12>Learner Surname : " + learner_surname +
                "</div><div class=col-sm-12>Learner Id Number : " + learner_id_number +
                "</div><div class=col-sm-12>Learner Class Name : " + learner_classname +
                "</div><div class=col-sm-12>Learnership Sub Type : " + sub_type +
                "</div><div class=col-sm-12>Replacement Learner Details : " + replacement_learner_details +
                "</div><div class=col-sm-12>Date of Resignatione : " + date_of_resignation +
                "</div><div class=col-sm-12>Reason For Dropping Out : " + reason_for_dropping_out +
