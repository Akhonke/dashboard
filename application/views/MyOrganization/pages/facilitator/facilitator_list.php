            ...
            <div class="col-lg-12 mb-1">
                <div class="card">
                    <div class="card-header">
                        <h3 class="h6 text-uppercase mb-0">Faciliators List</h3>
                    </div>
                    <div class="card-body">
                                    ...
                                    ?>
                                            <tr id="del-<?= $row->id ?>">
                                                ...
                                                <td>
                                                    ...
                                                    <!-- 
                                               <a href="create_facilitator?id=<?= $row->id ?>" class="btn btn-info btn-sm"><i
                                                        class="fa fa-edit"></i></a>
                                                <a href="javascript:;" class="btn btn-danger btn-sm" style="margin:5px 0 0"onclick="deletedataFacilitator('facilitator&behalf','id','<?= $row->id ?>','<?= $trainer_nm ?>')"><i
...
<script>
    function view() {
        $("#exampleModal").modal({
            ...
            // var src = $(event.relatedTarget).closest("tr").find("td:eq(16) div:eq(1).text-center img").attr("src");
            ...
            $(this).find("#personDetails").html($("<div class=row><div class=col-sm-12><span class='pull-left'>Trainer Name   :  </span><span class='pull-right'>" + trainer_nm +
                ...
                // "</div><div class=col-sm-12><span class='pull-left'>Attach Documents: " + ' <img width="50" src="'+ src +'" / > ' +
