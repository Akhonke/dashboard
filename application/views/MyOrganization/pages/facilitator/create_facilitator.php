            ...
            <div class="col-lg-12 mb-1">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <h3 class="h6 text-uppercase mb-0"><?= $name ?> Faciliator</h3>
                        ...
                        <form class="form-horizontal" method="post" enctype="multipart/form-data" id="CreateAssessorForm">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" placeholder="Enter Mobile Your Number" name="mobile" class="form-control" value="<?= (isset($record)) ? $record->mobile : ''; ?>"  style="position: relative;padding-left: 50px;" pattern="[0-9]{9}" title="Mobile number 9 digit with 0-9">
