            ...
            <div class="col-lg-12 mb-1">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <h3 class="h6 text-uppercase mb-0">Programme Directors List</h3>
                                ...
                                <tbody>
                                    ...
                                    <tr id="del-<?= $row->id ?>">
                                        ...
                                        <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></a>           
                                            <a href="create_programmer?id=<?= $row->id ?>"

                                                class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>

                                            <a href="javascript:;" class="btn btn-danger btn-sm" style="margin:5px 0 0"onclick="deleterecordprogrammedirector('programme_director&behalf','id',<?= $row->id?>)"><i

                                                        class="fa fa-trash"></i></a>

                                            <?php $tablenm_id ='programme_director'.'.'.$row->id; 

                                                ?>

                                            <i data="<?php echo $tablenm_id;?>"
