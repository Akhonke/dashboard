            ...
            <div class="col-lg-12 mb-1">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <h3 class="h6 text-uppercase mb-0">Add New Assessor</h3>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" placeholder="Enter Your Landline Number" name="landline"
                                        ...
                                        class="form-control" value="<?= (isset($record)) ? $record->landline : ''; ?>" style="position: relative;padding-left: 50px;" pattern="[0-9]{9}" title="Landline number 9 digit with 0-9">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" placeholder="Enter Your Mobile Number" name="mobile"
                                        ...
                                        class="form-control" value="<?= (isset($record)) ? $record->mobile : ''; ?>" style="position: relative;padding-left: 50px;" pattern="[0-9]{9}" title="Mobile number 9 digit with 0-9">
                                    ...
                                    <div class="row">
                                        ...
                                        <div id="remove_file<?=$key?>">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <img src="<?= BASEURL.'uploads/acreditationsfiles/'.$value['acreditations_file'] ?>"
