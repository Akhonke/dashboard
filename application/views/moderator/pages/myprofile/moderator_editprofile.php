                           ...
                           <label class="form-control-label">Region</label>
                             ...
                             <select class="form-control" id="region" name="region">
                              ...
                              <?php if (empty(($record->region))) { ?>
                                       ...
                                       <option label="" value="" hidden>Choose Your Region</option>
                        ...
                        <div class="field_wrapper col-md-12">
                           <div class="row">
                              ...
                              <div id="remove_file<?=$key?>">
                                 ...
                                 <div class="col-md-6">
                                    <label class="form-control-label">Acreditations</label>
                                    <img src="<?= BASEURL.'uploads/moderator/acreditationsfiles/'.$value['acreditations_file'] ?>"
