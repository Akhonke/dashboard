...
<head>
    ...
    <title>DigiLims | Internal Moderator Login</title>
        ...
        <div class="container py-5">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 px-lg-4">
                    ...
                    <h1 class="text-base text-primary text-uppercase mb-4">Learning Manegment</h1>

                    <h2 class="mb-4">Welcome Back Moderator!</h2>
                   ...
                   <p>Please enter your email and password to continue</p>
                    ...
                    <form id="loginForm" class="mt-4" method="POST">
                        ...
                        <div class="form-group mb-4">
                          ...
                          <a href="<?=base_url('internal-moderator-forget-password')?>"
