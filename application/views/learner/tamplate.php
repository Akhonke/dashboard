...
<body>
    <?php $this->load->view('learner/layout/header', $data); ?>
    <div class="d-flex align-items-stretch">
        <?php $this->load->view('learner/layout/sidebar', $data); ?>
        <div class="page-holder w-100 d-flex flex-wrap">
            <?php $this->load->view('learner/' . $content); ?>
            <?php $this->load->view('learner/layout/footer'); ?>
        </div>
    </div>
