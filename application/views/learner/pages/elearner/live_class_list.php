            ...
            <div class="col-lg-12 mb-1">
                <div class="card">
                    <div class="card-header">
                        <h3 class="h6 text-uppercase mb-0">Live Class List</h3>
                    </div>
                    <div class="card-body">
       ...
       // debugger;
  		...
  		$("#exampleModal").modal({
            ...
            var mobile = $(event.relatedTarget).closest("tr").find("td:eq(7)").text(); 
              ...
              "</span></div><div class=col-sm-12><span class='pull-left'>Project Manager Name :</span><span class='pull-right'> " + project_manager + 
              "</span></div><div class=col-sm-12><span class='pull-left'> Training Provider :</span> <span class='pull-right'>" + trainer_nm + 
              "</span></div><div class=col-sm-12><span class='pull-left'>Class Name  : </span><span class='pull-right'> " + class_name + 
              "</span></div><div class=col-sm-12><span class='pull-left'>Date  :</span><span class='pull-right'>  " + date + 
              "</span></div><div class=col-sm-12><span class='pull-left'>Time   :</span><span class='pull-right'>  " + time +
              "</span></div><div class=col-sm-12><span class='pull-left'>Mobile  :</span><span class='pull-right'>  " + mobile +
              "</span></div><div class=col-sm-12><span class='pull-left'>Email   : </span><span class='pull-right'> " + email + 
              "</span></div><div class=col-sm-12><span class='pull-left'>Link   : </span><span class='pull-right'> " + link + 
