<header class="header">
    <nav class="navbar navbar-expand-lg px-4 py-2 bg-white shadow">
      <?php $moderator_id = $_SESSION['external_moderator']['id'];
        ...
        <ul class="ml-auto d-flex align-items-center list-unstyled mb-0">
            ...
            <li class="nav-item dropdown ml-auto"><a id="userInfo" href="javascript:;" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">
                   <?php if(empty($moderator->profile_image))
                    { ?>
                        <img src="<?= base_url() ?>/uploads/learner/profile_image/no_image.png" alt="Jason Doe" style="max-width: 2.5rem;" class="img-fluid rounded-circle shadow"></a>

                  <?php  }else{ ?>
                        <img src="<?= base_url() ?>/uploads/external_moderator/profile_image/<?= $moderator->profile_image; ?>" alt="Jason Doe" style="max-width: 2.5rem;height: 2.5rem" class="img-fluid rounded-circle shadow"></a>
                ...
                <div aria-labelledby="userInfo" class="dropdown-menu"><a href="#" class="dropdown-item"><strong class="d-block text-uppercase headings-font-family"><?php
                    ...
                    <div class="dropdown-divider"></div><a href="<?= BASEURL ?>external-moderator-changepassword" class="dropdown-item">Change Password</a>
                    <div class="dropdown-divider"></div><a href="<?= BASEURL ?>external-moderator-editprofile" class="dropdown-item">Edit Profile</a>
                    <!-- <div class="dropdown-divider"></div><a href="#" class="dropdown-item">Settings</a> -->
                    <div class="dropdown-divider"></div><a href="<?= BASEURL ?>external-moderator-logout" class="dropdown-item">Logout</a>
                </div>
            </li>
        </ul>
    </nav>
