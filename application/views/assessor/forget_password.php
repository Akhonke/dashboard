            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-4 mx-auto  mb-lg-0">
                    ...
                    <div class="login-box" id="login-box">
                        ...
                        <form id="ForgetForm" class="mt-4" method="POST" action="<?= base_url('assessor-forget-password') ?>">
                            ...
                            <a href="<?= base_url('assessor') ?>" class="btn px-5 float-right foget-button">Login to Account</a>
