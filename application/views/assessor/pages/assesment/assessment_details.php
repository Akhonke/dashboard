                                    	...
                                    	<?php foreach ($learner_assessment_submissions as $assessment_submission) { ?>
											<li>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea class="form-control"  name="assessment_notes" id="assessment_notes" cols="60" rows="5"><?= (isset($assessment_submission)) ? $assessment_submission->assessment_notes : ''; ?></textarea>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea class="form-control"  name="learner_feedback" id="learner_feedback" cols="60" rows="5"><?= (isset($assessment_submission)) ? $assessment_submission->learner_feedback : ''; ?></textarea>
