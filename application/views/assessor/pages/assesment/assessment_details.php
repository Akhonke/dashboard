...
*/ ?>
                                        ...
                                        <div class="col-md-12">
        									<?php if (!empty($record->upload_assessed_workbook)) { ?>
        										<p>
        										Marked Workbook : <a href="/uploads/assessment/upload_assessed_workbook/<?php echo $record->upload_assessed_workbook; ?>" target="_blank"><?php echo $record->upload_assessed_workbook_name; ?></a>
        										</p>
        									<?php } else { ?>
                                    			<label class="form-control-label">Upload The Assessed Workbook<span style="color:red;font-weight:bold;"> *</span></label>
                                        ...
                                        <div class="col-md-12">
    										<?php if (!empty($record->upload_assessed_learner_feedback)) { ?>
        										<p>
                                        ...
                                        <div class="col-md-12">
    										<?php if (!empty($record->upload_assessed_overall_report)) { ?>
        										<p>
